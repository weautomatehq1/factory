...
| R-013 | Client interview reveals scope wildly different from expected | Client wants something The Factory can't build (mobile app, ML pipeline) | Wasted interview; awkward conversation; NoGo-2 invoked | 6 | 4 | 3 | 72 | Pre-call screening questionnaire (future milestone — not yet scheduled in ROADMAP.md); INTAKE flags NoGo categories early; Layer 2 redirects out-of-scope topics | sebas | open | 2026-05-15 |
