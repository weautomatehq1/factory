...
### Changed
- **2026-07-09 — Nightly audit fixes** (10 findings fixed — 6 IMPORTANT, 4 COSMETIC). ARCHITECTURE.md: frontmatter last_updated corrected 2026-05-26→2026-07-09, §6 cost-tracking owner corrected M-019→M-018, §4 codemap expanded with docs/postmortems/ and docs/templates/ — closes AUDIT-factory-a4b2e7f1, AUDIT-factory-1a7e3c90, AUDIT-factory-e1a3d7c0. SECURITY.md + ROADMAP.md: frontmatter last_updated corrected 2026-05-26→2026-07-09 and 2026-07-01→2026-07-09 — closes AUDIT-factory-f3a1c8d2, AUDIT-factory-9c5d3f8e. STATUS.md: SPRINT-B overdue 47→49 days, Retell R1 overdue 48→50 days, stale "42 days" in Open questions corrected to 50 — closes AUDIT-factory-2b5e7c9d, AUDIT-factory-d6f0b3c8. NON_GOALS.md: NoGo-6 "M-026+" replaced with "not yet scoped — planned after M-024", section header sprint date clarified — closes AUDIT-factory-3b8d1e5a, AUDIT-factory-4a7c9e3f. DECISIONS.md: ADR-0006 status corrected superseded→"superseded by 0011" per lifecycle spec §4 — closes AUDIT-factory-6d1f8a4b. AGENTS.md: §3 codemap expanded, §13 pre-push gap tracking reference added — closes AUDIT-factory-f8a1c3e6. 5 findings remain open/deferred: AUDIT-factory-c43b9ae1 (ADR-0011 missing MADR sections — cannot edit accepted ADR), AUDIT-factory-b71a4c92 (SPRINT-B missing — needs Sebastian/Esme), AUDIT-factory-2e8f6d40 (RISKS.md risk review overdue — requires operator), AUDIT-factory-5a9e2c7f (SECURITY.md Protected Paths glob gap — requires operator), AUDIT-factory-7c2e4f9b (unverified status URLs — requires operator verification). ⚠️ SPRINT-B now 49 days overdue; Q3 OKRs still undefined.
