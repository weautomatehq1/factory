...
### Changed
- **2026-06-05 — Nightly audit fixes** (4 findings fixed, 0 remain open). CHANGELOG.md: added missing 2026-05-30 nightly audit entry — closes AUDIT-factory-ea932b34. STATUS.md: updated In-flight entry for audit/nightly-2026-05-30 (push had completed 6 days prior) — closes AUDIT-factory-f1e0f9fc. ENV.md: added clarifying note to rotation calendar for conditional entries — closes AUDIT-factory-c856e7d6. DECISIONS.md last_updated date refreshed — closes AUDIT-factory-bf5bd31d. SPRINT-2026-05-B still not created (now 15 days overdue); Retell R1 confirmation still pending — both require human decision.
- **2026-05-30 — Nightly audit fixes** (7 findings fixed from prior runs). ADR-0006: erratum appended resolving lazy 'NG-something equivalent' reference — closes AUDIT-factory-3622c711. ROADMAP.md: ACTION REQUIRED deadline notice added for Retell R1 confirmation — closes AUDIT-factory-b01a3d58. RUNBOOK.md: Factory SLOs table added — closes AUDIT-factory-c5e702e1. ARCHITECTURE.md §6: logging standard added (JSON schema, levels, PII rules) — closes AUDIT-factory-47e08664. STATUS.md: SPRINT-B day-9-overdue status documented — closes AUDIT-factory-f2d80a11. ENV.md: Last verified date corrected to 2026-05-30 — closes AUDIT-factory-1a2b3c4d. STATUS.md: stale In-flight entry for nightly-2026-05-26 replaced — closes AUDIT-factory-2b3c4d5e.
