...
- **rate_limits:** TBD — Esme R1 research 76 days overdue; blocked on account creation (M-005)
...
- **owner:** sebas
- **lifecycle:** experimental (account not yet created — blocked on M-005; see ADR-0011)
...
**Last verified:** 2026-08-04 — nightly audit (Retell rate_limits overdue count updated 74 → 76 days; footer date corrected from 2026-07-19 to match frontmatter — closes AUDIT-factory-integrations-footer-mismatch-20260804)
