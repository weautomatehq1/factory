...
### Changed
- **2026-06-11 — Nightly audit fixes** (1 finding fixed — 1 COSMETIC). KPI.md: KR3 deadline banner corrected from "3 days away" to "deadline passed 2026-06-10"; KR3 KR entries updated to reflect deadline passed — closes AUDIT-factory-aeec331e. STATUS.md: In-flight day count corrected from "day 17 overdue" to "day 21 overdue"; Up-next "14 days overdue" corrected to "21 days overdue".
