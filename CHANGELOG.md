...
### Changed
- **2026-07-12 — Nightly audit fixes** (10 findings fixed — 5 IMPORTANT, 5 COSMETIC). CHANGELOG.md: missing 2026-07-08 entry added — closes AUDIT-factory-e4f1c2b3. ARCHITECTURE.md: frontmatter last_updated synced 2026-05-26→2026-07-12 — closes AUDIT-factory-d8a5c012. SECURITY.md: frontmatter last_updated synced 2026-05-26→2026-07-12 — closes AUDIT-factory-b3e79f14. KPI.md: frontmatter synced 2026-06-25→2026-07-12; Retell R1 overdue count 48→53 days — closes AUDIT-factory-c1d2f4a8, AUDIT-factory-e0a1b2c3. ROADMAP.md: frontmatter synced 2026-07-01→2026-07-12; Q3 blocking decision count 48→53 days — closes AUDIT-factory-b5f6e7d9, AUDIT-factory-d4e5f6a7. INTEGRATIONS.md: Retell R1 overdue count 48→53 days — closes AUDIT-factory-b8c9d0e1. STATUS.md: overdue counts 47/48→52/53 days — closes AUDIT-factory-f6b7c8d9. .audits/index.json: 8 stale-open findings cleared (fixed by 2026-07-08 commit) — closes AUDIT-factory-a2c3e4f5. 3 findings remain open: AUDIT-factory-a5d3e092 (SECURITY.md /(auth)/** — operator), AUDIT-factory-71c4b389 (no active sprint — human), AUDIT-factory-4abde52c (orphaned ID — unknown). ⚠️ SPRINT-B now 52 days overdue; Q3 OKRs still undefined.
- **2026-07-08 — Nightly audit fixes** (10 findings fixed — 3 CRITICAL, 5 IMPORTANT, 2 COSMETIC). AGENTS.md §1: spec-template repo added to sibling repos list — closes AUDIT-factory-8099fb00. README.md: CLAUDE.md footnote added to 17-spec-files table — closes AUDIT-factory-9d8028ef. INTEGRATIONS.md: Retell lifecycle corrected from 'production' to 'experimental (account not yet created)' — closes AUDIT-factory-1628fceb. STATUS.md: 42→48 days counter inconsistency fixed — closes AUDIT-factory-7e8c1eea. NON_GOALS.md: sprint header updated from stale date to '(standing — pending SPRINT-2026-05-B)' — closes AUDIT-factory-9e2e2cb7. ARCHITECTURE.md: 'spec-template (new repo)' label corrected; OMC_KILLSWITCH added to cross-cutting table; 'NEW:' labels changed to 'PLANNED:' — closes AUDIT-factory-60e00c09, AUDIT-factory-b196aaab, AUDIT-factory-b9a43e43. ROADMAP.md Now section header updated — closes AUDIT-factory-56a7982f. INTEGRATIONS.md Retell rate_limits TBD note updated with overdue ref — closes AUDIT-factory-5a72c4fb. FILE_STRUCTURE.md + AGENTS.md: .audits/ added to directory trees — closes AUDIT-factory-5b026618. ENV.md: 'Esmel' typo corrected to 'Esme' — closes AUDIT-factory-0c3ff30f. UBIQUITOUS_LANGUAGE.md: ~/dev path replaced with GitHub URL — closes AUDIT-factory-7229b7db. NON_GOALS.md: broken cross-reference corrected — closes AUDIT-factory-7014eefb.
