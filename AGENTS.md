...
- **Conventional Commits:** `<type>(<scope>): <imperative description>`.
  ...
  - Example: `chore(adr): add ADR-NNNN for n8n vs Inngest` (use the next available number)
...
**Last verified:** 2026-08-23 — nightly audit (footer date verified; no body changes this cycle — last body edit 2026-08-02)
