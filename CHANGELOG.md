...
### Changed
- **2026-06-26 — Nightly audit fixes** (2 findings fixed — 1 IMPORTANT, 1 COSMETIC). ROADMAP.md: M-005 `adrs` field corrected from `[ADR-0006]` to `[ADR-0011]` — ADR-0006 was superseded by ADR-0011 (noted in Q3 section since 2026-06-07 but M-005 milestone block was missed). SPRINT.md: `last_updated` frontmatter field added (was missing; value matches existing `reconciled_at: 2026-05-21`).
