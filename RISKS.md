...
| R-010 | KPI regression goes undetected | KPI.md remains skeleton; self-heal has nothing to anchor on | Self-heal silently misbehaves post-launch | 7 | 7 | 8 | 392 | KPI.md MUST be populated before launch (gate); skeleton status reviewed weekly; baseline metrics captured in first 7 days of production | sebas | open | 2026-05-15 |
