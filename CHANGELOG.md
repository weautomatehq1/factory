...
### Changed
- **2026-07-25 — Nightly audit fixes** (5 findings fixed — all COSMETIC). STATUS.md: SPRINT-B overdue count updated 59→65 days, Retell R1 overdue count updated 60→66 days, Q3 elapsed 18→24 days, last-updated line refreshed — closes AUDIT-factory-a3b4c5d6. KPI.md: Q3 ACTION REQUIRED updated 60→66 days overdue, ADR-0011 pending 54→60 days, Q3 elapsed 18→24 days, frontmatter + footer dates updated — closes AUDIT-factory-e7f8g9h0. ROADMAP.md: Q3 blocking decision elapsed count updated 60→66 days, frontmatter + footer dates updated — closes AUDIT-factory-i1j2k3l4. INTEGRATIONS.md: Retell rate_limits overdue count updated 60→66 days, frontmatter + footer dates updated — closes AUDIT-factory-m5n6o7p8. CHANGELOG.md: this entry — closes AUDIT-factory-q9r0s1t2. 2 findings remain open: AUDIT-factory-a5d3e092 (SECURITY.md Protected Paths gap — requires operator review), AUDIT-factory-71c4b389 (no active sprint — requires Sebastian/Esme). ⚠️ SPRINT-B now 65 days overdue; Q3 OKRs still undefined (24 days into Q3).
