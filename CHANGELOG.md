...
### Changed
- **2026-07-10 — Nightly audit fixes** (11 findings fixed — 8 were already fixed in files by 2026-07-08 commit but index never updated; 3 new). ADR-0006: status field conformed from non-standard `superseded by ADR-0011` to standard `superseded` — closes AUDIT-factory-e3c82a17. CHANGELOG.md: retroactive 2026-07-08 entry added — closes AUDIT-factory-f7b941c3. STATUS.md: footer date refreshed, overdue counts updated 47/48→50/51 days — closes AUDIT-factory-a52de094. Index: 8 prior-cycle open findings confirmed fixed-in-files and closed (7e8c1eea STATUS.md count, 9e2e2cb7 NON_GOALS.md header, 60e00c09 ARCHITECTURE.md spec-template label, b196aaab ARCHITECTURE.md OMC_KILLSWITCH, 56a7982f ROADMAP.md Now section, 5a72c4fb INTEGRATIONS.md rate_limits, 5b026618 FILE_STRUCTURE.md+AGENTS.md .audits tree, b9a43e43 ARCHITECTURE.md PLANNED labels). ROADMAP.md + INTEGRATIONS.md: Retell R1 overdue count updated 48→51 days. 2 findings remain open: AUDIT-factory-a5d3e092 (SECURITY.md Protected Paths gap — operator review), AUDIT-factory-71c4b389 (no active sprint — operator decision). ⚠️ SPRINT-B now 50 days overdue; Q3 OKRs still undefined.
- **2026-07-08 — Nightly audit fixes** (14 findings fixed — 3 CRITICAL, 7 IMPORTANT, 4 COSMETIC). INTEGRATIONS.md: Retell lifecycle corrected from `production` to `experimental (account not yet created — blocked on M-005; see ADR-0011)` — closes AUDIT-factory-1628fceb. AGENTS.md §1: `spec-template` added to sibling repos list — closes AUDIT-factory-8099fb00. README.md: CLAUDE.md table footnote added (`† Not one of the 17 canonical spec files`) — closes AUDIT-factory-9d8028ef. ARCHITECTURE.md: spec-template subgraph `(new repo)` label removed — closes AUDIT-factory-60e00c09. ARCHITECTURE.md: `OMC_KILLSWITCH` added to cross-cutting killswitches table — closes AUDIT-factory-b196aaab. ARCHITECTURE.md: `NEW: M-NNN` labels changed to `PLANNED: M-NNN` for unshipped IFleet milestones — closes AUDIT-factory-b9a43e43. ROADMAP.md: Now section header updated to reflect no active sprint — closes AUDIT-factory-56a7982f. FILE_STRUCTURE.md + AGENTS.md §3: `.audits/` directory added to factory repo tree — closes AUDIT-factory-5b026618. NON_GOALS.md: stale sprint header updated to `standing — last reviewed for sprint SPRINT-2026-05-A; pending SPRINT-2026-05-B re-evaluation` — closes AUDIT-factory-9e2e2cb7. STATUS.md: `42 days overdue` in Open questions conformed to `48 days overdue` — closes AUDIT-factory-7e8c1eea. INTEGRATIONS.md: Retell rate_limits TBD note updated with overdue reference — closes AUDIT-factory-5a72c4fb. ENV.md: typo `Esmel` → `Esme` — closes AUDIT-factory-0c3ff30f. UBIQUITOUS_LANGUAGE.md: local `~/dev/ai-products/IFleet` path replaced with GitHub URL — closes AUDIT-factory-7229b7db. NON_GOALS.md NoGo-1: broken `STAKEHOLDERS.md project overview` cross-ref corrected — closes AUDIT-factory-7014eefb. ⚠️ NOTE: this entry was missing from CHANGELOG — added retroactively by 2026-07-10 nightly audit (closes AUDIT-factory-f7b941c3).
