...
### Changed
- **2026-07-15 — Nightly audit fixes** (4 findings fixed — all COSMETIC). STATUS.md: SPRINT-B overdue count updated 53→55 days, Retell R1 overdue count updated 54→56 days, Q3 days-in updated 12→14, last-updated line refreshed — closes AUDIT-factory-c4d7e891. KPI.md: Q3 ACTION REQUIRED updated 54→56 days overdue, 12→14 days in, ADR-0011 pending count updated 48→50 days, footer date updated — closes AUDIT-factory-d5e8f902. ROADMAP.md: Q3 blocking decision elapsed count updated 54→56 days, frontmatter + footer dates updated — closes AUDIT-factory-e6f9a013. CHANGELOG.md: this entry — closes AUDIT-factory-f7a0b124. 2 findings remain open: AUDIT-factory-a5d3e092 (SECURITY.md Protected Paths gap — requires operator review per AGENTS.md §7 "ask first"), AUDIT-factory-71c4b389 (no active sprint — requires Sebastian/Esme decision). ⚠️ SPRINT-B now 55 days overdue; Q3 OKRs still undefined (14 days into Q3).
